...
export function ReportNavigation({ activeChannel }) {
  return (
    <nav aria-label="Canais do relatório" className="flex flex-wrap gap-2">
      ...
      <span className="rounded-lg border border-dashed border-line px-3.5 py-2 text-xs font-semibold text-muted" title="Novas redes usam um adaptador próprio de métricas">Novas redes em breve</span>
    </nav>
  );
}
