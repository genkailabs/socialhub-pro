  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-line bg-surface-2/60 p-4 text-xs text-muted leading-relaxed">
        ...
        <p>
          Cada post gerado pelo Piloto registra o consumo de texto (IA) e imagem (Pollinations/Render) no seu novo dashboard de <a href="/ai-costs" className="font-bold text-accent hover:underline">Custos IA</a>. Nenhum post é publicado sem que você valide na aba Aprovações.
        </p>
      </div>
    </div>
  );
