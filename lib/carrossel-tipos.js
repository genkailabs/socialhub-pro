...
export const TIPOS = [
  {
    ...
    templatesAlternativos: ['palavra-marcada', 'manchete-noticia', 'texto-longo']
  },
  {
    id: 'case-sucesso',
    ...
    templatesAlternativos: ['recorte-editorial', 'revista-cultural', 'print-no-texto']
  },
  {
    id: 'comparacao',
    label: 'Comparação',
    ...
    templatesAlternativos: ['branco-respiro']
  },
  {
    id: 'lista',
    label: 'Lista',
    ...
    templatesAlternativos: ['foto-embaixo']
  },
  {
    id: 'educativo',
    label: 'Educativo',
    ...
    templatesAlternativos: ['bloco-sobre-foto', 'preto-foto-central']
  },
  {
    id: 'dump',
    label: 'Bastidor (dump)',
    ...
    templatesAlternativos: ['mosaico-provas']
  },
  {
    id: 'prova-social',
    label: 'Prova social',
  ...
  },
  {
    ...
    templateSugerido: 'bold-numbers',
    templatesAlternativos: ['chapado-brasa', 'fecho-palavra']
  }
];
