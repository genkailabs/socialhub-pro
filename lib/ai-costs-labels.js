...
export const ACTION_LABELS = {
  ...
  'carousel-assuntos': 'Busca de assunto do carrossel',
  'carousel-directions': 'Promessas de capa do carrossel',
  'carousel-full-brief': 'Roteiro de carrossel',
  'carousel-image': 'Imagem do carrossel',
  'instagram-trends': 'Busca de tendências'
};
