...
// Invalida o layout que resolve a jornada.
//
// Sem isto o agente trava no passo anterior até um F5: quem calcula a etapa é
// app/(app)/layout.jsx, e as actions do produto (diagnóstico, DNA, estratégia,
// plano) revalidam só a própria tela — nenhuma delas sabe que existe um layout
// dependendo dos mesmos dados. router.refresh() sozinho não resolve porque o
// payload do layout continua válido no cache.
//
// Fica aqui, e não espalhado nas cinco actions, para o produto não precisar
// lembrar da jornada toda vez que alguém mexer nelas.
