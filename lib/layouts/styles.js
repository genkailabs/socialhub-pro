...
export const VISUAL_STYLES = [
  ...
  },
  {
    id: 'tecnologia',
    label: 'Tecnologia',
    fonts: { title: 'Poppins', body: 'JetBrains Mono', accent: 'Poppins' },
...
export function styleInsets(style, { width = 430, height = 430 } = {}) {
  ...
  // Peça alta tem interface do Instagram por cima (perfil no topo, barra de
  // resposta embaixo): texto colado na borda fica atrás do app.
  const vertical = height > width ? Math.round(height * 0.075) : x;
