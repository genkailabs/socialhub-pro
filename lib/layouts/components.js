...
export const COMPONENTS = [
  ...
  {
    // §1.4: notícia sem fonte visível é boato bonito. O crédito é um componente
    // próprio, e não um pedaço do rodapé, porque as estruturas jornalísticas
    // precisam posicioná-lo separado da assinatura da marca.
    id: 'fonte',
    label: 'Fonte',
    layerType: 'text',
    styleRole: 'meta',
    ...
    limits: { max: 48 },
    wrap: ['Fonte: ', ''],
    defaults: { weight: 500, align: 'left', fill: 'transparent' }
  },
  {
    id: 'data',
    label: 'Data',
