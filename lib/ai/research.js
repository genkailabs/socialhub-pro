...
import { TAVILY_SEARCH_USD } from '@/lib/ai/cost';
...
// Busca contexto atual via Tavily Search. Contrato: sucesso devolve
...
// Custo da Tavily é por busca (créditos), não por token → valor fixo por chamada.
