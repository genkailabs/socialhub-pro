...
// Preço do OpenRouter (USD por milhão de tokens) — único provedor de texto do
// produto desde 2026-08-04. Ajuste conforme a tabela vigente do modelo escolhido
// em OPENROUTER_TEXT_MODEL.
export const OPENROUTER_PRICING = {
  'openai/gpt-4o-mini': { inPerM: 0.15, outPerM: 0.60 }
};

const PRICING = { ...DEEPSEEK_PRICING, ...GROQ_PRICING, ...OPENROUTER_PRICING };
