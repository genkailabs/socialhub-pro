...
import { selectLayout, layoutById } from '@/lib/ai/art/layouts';
...
export function applyFix({ issue, content, palette, layout, sizeId, recentLayouts }) {
  switch (issue.id) {
    ...
    case 'peca_vazia':
      // Conteúdo curto demais não se resolve inventando texto: a peça sobe com
      // o layout mais generoso e o problema fica registrado.
      return { layout: layoutById('hero') || layout };
    default:
