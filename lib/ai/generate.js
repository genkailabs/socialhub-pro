...
export async function generateCreative({ supabase, brandId, brandName, brandColor, kit, brief, composerContext = null, generateImages = true, maxImages = null, allowResearch = true, verifiedResearch = null }) {
  ...
  try {
    ...
    if (uploadedPaths.length) {
      try { await mediaBucket.remove(uploadedPaths); } catch {}
    }
    throw error;
  }
