...
// A IA acerta o conceito e erra a grafia: em produção o plano inteiro foi
// recusado por "consideração" e "decisão" com acento, e por sinônimos de funil
// ("topo", "meio", "fundo"). Recusar 7 dias de planejamento por causa da
// acentuação de um campo é desperdício — aqui a palavra é normalizada antes de
// validar, e só o que não tem correspondência é que continua sendo erro.
const STAGE_ALIASES = {
...
export function normalizeStage(value) {
  ...
  return STAGE_ALIASES[key] ?? value;
}

const stage = z.preprocess(normalizeStage, z.enum(['descoberta', 'consideracao', 'decisao']));
