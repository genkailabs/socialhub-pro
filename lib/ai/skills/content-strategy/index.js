...
export const outputSchema = z.object({
  ...
  // Só o que o MVP planeja hoje: recomendar Reel criaria estratégia que o
  // Planejamento não consegue executar (§12).
  formats: z.array(z.enum(plannableFormatIds())).max(4),
