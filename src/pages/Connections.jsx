...
const defaultNetworks = [
  {
    ...
    steps: [
      'Configure sua conta como Profissional (Criador de Conteudo ou Empresa).',
      'Vincule sua conta a uma Pagina publica do Facebook.',
      'Clique em "Conectar" e autorize o acesso a metricas e publicacoes.',
      'Apos a confirmacao, seu perfil aparecera como Conectado.'
    ]
  },
  {
    id: 'facebook',
    name: 'Facebook',
    subtitle: 'Pagina Comercial',
    icon: Facebook,
    ...
    handle: '',
    expiresIn: null,
    tutorialTitle: 'Conexao Integrada com Facebook Pages',
    steps: [
      'Conectado automaticamente junto com seu Instagram Business.',
      'Para paginas separadas, clique em "Conectar" e selecione as paginas.',
      'Permite analise de visualizacoes, engajamento e compartilhamentos.'
    ]
  },
  {
    id: 'tiktok',
    ...
    steps: [
      ...
      'Clique em "Conectar" e autorize na pagina oficial do TikTok.',
      'Autorize as permissoes de publicacao e leitura de perfil.',
      'Acompanhe taxa de viralidade e tempo medio de exibicao.'
    ]
  },
  {
    id: 'linkedin',
    name: 'LinkedIn',
    subtitle: 'Company Page / Perfil',
    icon: Linkedin,
    ...
    handle: '',
    expiresIn: null,
    tutorialTitle: 'Como conectar a Pagina de Empresa do LinkedIn',
    steps: [
      'Voce deve ser Administrador (Super Admin) da Company Page.',
      'Clique em "Conectar", faca login e conceda as permissoes.',
      'Publique artigos, fotos e monitore impressoes organicas vs patrocinadas.'
    ]
  },
  {
    id: 'youtube',
    name: 'YouTube',
    subtitle: 'Canal & Shorts',
    icon: Youtube,
    ...
    steps: [
      ...
      'Permita a consulta de estatisticas avancadas.',
      'Gerencie videos longos e Shorts em uma interface unificada.'
    ]
  },
  {
    id: 'twitter',
    name: 'X / Twitter',
    subtitle: 'Pro API & Posts',
    icon: IconX,
    ...
    steps: [
      'Acesse sua conta oficial no X com permissoes de leitura e escrita.',
      'Clique em "Conectar" para autorizar via OAuth 2.0 / X API Pro.',
      'Conceda acesso a estatisticas de tweets, impressoes e retweets.',
      'Agende threads e monitore metricas virais.'
    ]
  },
  {
    id: 'pinterest',
    name: 'Pinterest',
    subtitle: 'Business (Pins & Pastas)',
    icon: IconPinterest,
    ...
    steps: [
      ...
      'Permita acesso aos quadros e metricas de Pins Salvos.',
      'Seu catalogo estara pronto para agendamentos e analises.'
    ]
  },
  {
    id: 'whatsapp',
    name: 'WhatsApp',
    subtitle: 'Business API / Atendimento',
    icon: MessageSquare,
    ...
    steps: [
      'Abra o WhatsApp Business no celular oficial do seu negocio.',
      'Va em Aparelhos Conectados e toque em Conectar um aparelho.',
      'Aponte a camera para o QR Code gerado pelo nosso painel.',
      'Suas mensagens chegarao na aba Social Inbox com KPIs em tempo real.'
    ]
  },
  {
    id: 'spotify',
    name: 'Spotify',
    subtitle: 'Podcasters & Musicas',
    icon: Music,
    ...
    handle: '',
    expiresIn: null,
    tutorialTitle: 'Como vincular seus Podcasts ou Lancamentos no Spotify',
    steps: [
      'Ideal para criadores, selos musicais e agencias de artistas.',
      'Clique em "Conectar" e faca login com sua conta de artista.',
      'Autorize a leitura dos seus catalogos e analise de streams.',
      'Aproveite a pre-visualizacao interativa dos seus lancamentos.'
    ]
  }
];
